    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    <hr>
                    <h2 class="intro-text text-center">Permanecemos <strong>atentos</strong> a tus
                        inquietudes
                    </h2>
                    <hr>
                    <p>Ponemos a su disposici&oacute;n en formualrio de contacto a continuaci&oacute;n para evacuar cualquier duda que puediera presentarsele.</p>
                    <br/><br/>

                    <form id="contactForm" class="form-horizontal" method="post" action=<?php echo "'".base_url()?>contacto/index<?php echo "'"?>>
                        <div class="form-group">
                            <label class="col-xs-3 control-label">&nbsp;<i class="glyphicon glyphicon-flag"></i>&nbsp;&nbsp;Nombre completo</label>
                            <div class="col-xs-4">
                        ...
                        <div class="form-group">
                            <label class="col-xs-3 control-label"><i class="glyphicon glyphicon-flag"></i>&nbsp;&nbsp;Mensaje</label>
                            <div class="col-xs-9">
