            ...
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <h2 class="intro-text text-center">Nuestras
                        <strong>Plegarias</strong>
                    </h2>
                    <hr>
                </div>
                {plegarias}
                <div class="col-sm-4 text-center">
                        <img src=<?php echo "'".base_url()?>gifs/vela.gif<?php echo "'"?>>
                    <p class="leyendaPlegarias">De: &nbsp;{de}</p>
                    <p class="leyendaPlegarias">Para: &nbsp;{para}</p>
                    <p class="leyendaPlegarias">{motivo}</p>   
                    <br/><br/>
                </div>
                {/plegarias} 
            </div>
